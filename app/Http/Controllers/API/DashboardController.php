    ...
    public function summary(Request $request): JsonResponse
    {
        ...
        if (in_array($role, ['admin', 'hr', 'manager'], true)) {
            $data = [
                ...
                'recent_attendances' => Attendance::with(['employee.user', 'shift'])->latest('attendance_date')->limit(5)->get(),
        ...
        $data = [
            ...
            'recent_attendances' => Attendance::with('shift')->where('employee_id', $employee->id)->latest('attendance_date')->limit(5)->get(),
